<template>
    <div class="card">
        ...
        <div class="card-body">
            <h2>Welcome to Parking Place!</h2>
            ...
            <ol>
                ...
                <li>Thank you for choosing Parking Place!</li>
            </ol>
            <form>
                <button type="submit" class="btn btn-primary" @click.prevent="enter">Enter Garage</button>
            </form>
        </div>
    </div>
</template>
